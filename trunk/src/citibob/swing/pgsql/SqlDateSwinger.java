 ...
 * @author citibob
 */
public class SqlDateSwinger extends TypedWidgetSwinger
{
String fmt;
DateFormat dfmt;
...
public SqlDateSwinger(SqlDateType sqlType, DateFormat dfmt) {
	super(sqlType);
	this.dfmt = dfmt;
}
...
public SqlDateSwinger(SqlDateType sqlType, Calendar cal, String fmt)
{
