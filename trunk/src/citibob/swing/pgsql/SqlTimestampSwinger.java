 ...
 * @author citibob
 */
public class SqlTimestampSwinger extends SqlDateSwinger
{
String fmt;
DateFormat dfmt;
...
public SqlTimestampSwinger(SqlDateType sqlType, DateFormat dfmt) {
	super(sqlType, dfmt);
}
...
public SqlTimestampSwinger(SqlDateType sqlType, Calendar cal, String fmt)
{
