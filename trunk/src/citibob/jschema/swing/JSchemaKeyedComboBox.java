 ...
 * @author  citibob
 */
public class JSchemaKeyedComboBox
...
public void setColName(String s)
	{ colName = s; }
// --------------------------------------------------------------
public JSchemaKeyedComboBox(SchemaRowModel bufRow, String colName)
{
	super();
	this.colName = colName;
	bind(bufRow);
}
public JSchemaKeyedComboBox()
	{ super(); }
...
{
	inValueChanged = true;
	setValue((Integer)bufRow.get(col));
...
//System.out.println(getSelectedItem().getClass());
		...
		if (it == null) bufRow.set(colNo, null);
		else bufRow.set(colNo, it.key);
	}
}
