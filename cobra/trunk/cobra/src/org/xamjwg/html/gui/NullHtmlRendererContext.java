 ...
 * @author J. H. S.
 */
public class NullHtmlRendererContext implements HtmlRendererContext {
	private final HtmlPanel parentComponent;
	
	public NullHtmlRendererContext(HtmlPanel contextComponent) {
		super();
