...
public class JavaObjectWrapper extends ScriptableObject {
	...
	public Object get(int index, Scriptable start) {
		...
		if(pinfo == null) {
			...
			try {
				...
				return JavaScript.getJavascriptObject(raw, this.getParentScope());
			} catch(Exception err) {
	...
	public Object get(String name, Scriptable start) {
		...
		if(pinfo != null) {
			...
			try {
				...
				return JavaScript.getJavascriptObject(val, start.getParentScope());
			} catch(Exception err) {
				throw new WrappedException(err);
			}
		}
	...
	public void put(String name, Scriptable start, Object value) {
		...
		if(pinfo != null) {
			...
			Function f = this.classWrapper.getFunction(name);
			if(f != null) {
				throw new EvaluatorException("Unable to set '" + name + "' (it's a function name)");
			}
			else {
				PropertyInfo ni = this.classWrapper.getNameIndexer();
				if(ni != null) {
	...
	public static Function getConstructor(String className, JavaClassWrapper classWrapper, Scriptable scope) throws Exception {
